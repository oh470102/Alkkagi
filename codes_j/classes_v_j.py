...
class game_state:
    ...
    def map_select(self):
        ...
        if self.selected_map_index == 0:
            pygame.draw.rect(self.screen, (255, 0, 0), ((80, 100),(160,160)),10)
        elif self.selected_map_index == 1:
            pygame.draw.rect(self.screen, (255, 0, 0), ((400, 100),(160,160)),10)
        else:
            pass
    ...
    # End screen !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    def End_screen_white():
        screen.fill("white")

        font1 = pygame.font.SysFont('arial',50)
        text1 = font1.render("White wins!",True, "blue")
        text1_rect = text1.get_rect(center=(screen.get_width() // 2, screen.get_height()*1/2))
        screen.blit(text1, text1_rect)

        pygame.display.flip()

    def End_screen_black():
        screen.fill("white")
            ...
            if event.type == pygame.KEYUP:
                ...
                if event.key == pygame.K_SPACE:
                    ...
                    if len(self.player1_stones) * len(self.player2_stones) == 0:
                        continue
                    elif self.turn == 1: self.curr = self.player1_stones[self.player1_index % len(self.player1_stones)]
